<div class="upload-zone" style="border: 2px dashed #e5e7eb; border-radius: 0.5rem; padding: 2rem; text-align: center; cursor: pointer; transition: border-color 0.2s;"
    ...
    <div style="color: #6b7280;">
        ...
        <p style="margin: 0; font-weight: 500;">{{ __($label ?? 'Click to upload or drag and drop') }}</p>
        <p style="margin: 0.25rem 0 0; font-size: 0.875rem;">{{ __($hint ?? 'PNG, JPG, GIF up to 10MB') }}</p>
    </div>
</div>
