<footer class="custom-footer-bg pt-5 footer" data-aos="zoom-in-down">
        ...
        <div class="custom-bottom-bar py-3">
            <div class="container text-center">
                <p class="text-dark paragraph mb-0">©Urheberrecht. Alle Rechte vorbehalten.</p>
            </div>
        </div>
    </footer>